...
export const metadata: Metadata = {
  ...
  description: "Explore IT solutions for hospitality, real estate, construction, logistics, manufacturing, education, government, and healthcare organisations in Abu Dhabi and the UAE.",
