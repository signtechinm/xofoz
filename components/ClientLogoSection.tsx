...
const clients = [
  ...
  { name: "Brighton College Abu Dhabi", logo: "/clients/brighton-college-abu-dhabi.png" },
  ...
  { name: "ADASI", logo: "/clients/adasi.jpg" },
  { name: "Likhitha", logo: "/clients/likhitha.jpg" },
  { name: "Aloft Hotels", logo: "/clients/aloft.jpg" },
  { name: "Minar Holdings", logo: "/clients/minar-holdings.png" },
  { name: "Ittihad International Investment LLC", logo: "/clients/ittihad-international-investment.png" },
  { name: "Force 10", logo: "/clients/force-10.jpg" },
  { name: "FAB Properties", logo: "/clients/fab-properties.jpg" },
];
...
const clientLogoScales: Record<string, number> = {
  ...
  "Minar Holdings": 1.55,
  "Ittihad International Investment LLC": 1.35,
  "FAB Properties": 1.35,
