const page = (title: string, keyword: string, summary: string, overview: string, inclusions: string[], industries: string[]) => {
  const fields: Record<string, string> = {
    ...
    "SECTION 8 — H2": "A clear next step for your business",
...
export const newServiceContent: Record<string, Record<string, string>> = {
  ...
  "adhics-compliance-services-abu-dhabi": page("ADHICS Compliance Services", "ADHICS compliance services", "Technical support to help organisations review systems, documentation, access controls, and operational readiness against applicable ADHICS requirements.", "Compliance readiness requires an accurate view of systems, policies, access, records, and the actions needed to close identified gaps.", ["Readiness assessment", "Technical controls review", "Documentation support", "Remediation planning"], ["Healthcare", "Government services", "Professional services", "Regulated organisations"]),
