...
export const industries: readonly IndustryDefinition[] = [
  {
    ...
    hero: {
      eyebrow: "IT solutions for hospitality businesses in Abu Dhabi — since 2015",
